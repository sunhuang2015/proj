    ...
    <div class="main-content">
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                    ...
                    <div class="center">
                        <h1>
                            <i class="ace-icon fa fa-apple green"></i>
                            <span class="red">项目跟踪</span>
                            <span class="white" id="id-text2">平台</span>
                        </h1>
                        <h4 class="blue" id="id-company-text">&copy; Sunhuang</h4>
                    </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="clearfix">
                                                <button type="reset" class="width-30 pull-left btn btn-sm">
                                                    ...
                                                    <span class="bigger-110">消除</span>
                                                </button>

                                                <button type="submit" class="width-65 pull-right btn btn-sm btn-success">
                                                    <span class="bigger-110">登记</span>
